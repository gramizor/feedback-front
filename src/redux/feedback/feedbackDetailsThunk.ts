...
export const updateFeedbackStatusForModerator = createAsyncThunk(
  "feedback/updateFeedbackStatusForModerator",
  async (
    {
      feedbackId,
      feedbackStatus,
    }: { feedbackId: string; feedbackStatus: string },
    { dispatch }
  ) => {
    let timer;
    try {
      ...
      const response = await axios.put(
        `/feedback/${feedbackId}/status/moderator`,
        {
